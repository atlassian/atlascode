...
export default class MentionPicker extends React.Component<
    {
    ...
    render() {
        ...
        return (
            <Dropdown
                ...
                target={
                    <Tooltip content={this.props.targetButtonTooltip} delay={600}>
                        <VSCodeButton appearance="icon" onClick={this.toggleOpen}>
