...
export class RovoDevApiClient {
    ...
    private async fetchApi(restApi: string, method: 'PUT', body?: BodyInit | null): Promise<Response>;
    private async fetchApi(restApi: string, method: 'GET' | 'POST' | 'PUT', body?: BodyInit | null): Promise<Response> {
