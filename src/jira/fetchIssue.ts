import { createIssueUI, EditIssueUI, editIssueUI } from '@atlassianlabs/jira-metaui-client'; // add back editIssueUI when we change jira-metaui-client
...
//         allFields = {};
//         let fetchedFields = await client.getFields();
//         if (fetchedFields) {
