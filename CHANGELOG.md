...
- **RovoDev**: Added optional `veryLargeRepo` attribute to the `PerformanceEvent` analytics type definition, aligning the TypeScript type with the runtime event payload for Data Portal registration.
