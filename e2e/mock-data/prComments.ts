export const prComment = {
    ...
    created_on: '2025-01-17T14:17:40+00:00',
    updated_on: '2025-01-17T14:17:40+00:00',
    user: {
        type: 'user',
    ...
    links: {
        self: {
            href: 'https://api.bitbucket.org/2.0/repositories/mockuser/test-repository/pullrequests/123/comments/pr-comment-123',
        },
        html: {
            href: 'https://bitbucket.org/mockuser/test-repository/pull-requests/123/_/diff#comment-pr-comment-123',
        },
    },
    pullrequest: {
        id: 123,
